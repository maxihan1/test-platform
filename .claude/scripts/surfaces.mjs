...
export const SURFACES = [
  ...
  { name: 'ADMIN', tier: 2, globs: ['apps/admin/src/catalog/**', 'apps/admin/src/execution/**', 'apps/admin/src/reporting/**', 'apps/admin/src/authoring/**', 'apps/admin/src/db/**', 'apps/admin/src/*.ts'] },
  // 훅도 CI 도 GUARD 다 — 안전 장치이고, 잘못 고치면 검사가 조용히 안 돈다.
  // CI 는 특히 그렇다 — 줄 하나를 빠뜨리면 그 검사가 영영 안 돌고 초록불만 남는다
